...
void CircuitRenderer::ProcessMesh(aiMesh* _mesh, const aiScene* _scene)
{
...
void CircuitRenderer::ProcessNode(aiNode* node, const aiScene* scene)
{
...
bool CircuitRenderer::LoadModel()
{
...
void CircuitRenderer::Init(std::string_view _path)
{
